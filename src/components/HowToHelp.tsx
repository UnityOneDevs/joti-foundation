      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-16'>
          ...
          <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
            ...
            difference in someone&apos;s life. Choose the way that works best
            for you to support our mission.
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-3 gap-8'>
          {helpOptions.map((option) => (
            <div key={option.id} className='text-center group'>
              <div
                className={`w-20 h-20 bg-gradient-to-r ${option.color} rounded-full flex items-center justify-center text-4xl mb-6 mx-auto group-hover:scale-110 transition-transform duration-300`}
              >
                {option.icon}
              </div>
              ...
              <button
                className={`bg-gradient-to-r ${option.color} text-white px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition-opacity duration-300 w-full`}
              >
                {option.buttonText}
              </button>
            </div>
        ...
        <div className='mt-16 text-center'>
          <div className='bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 max-w-4xl mx-auto'>
            ...
            <p className='text-gray-600 mb-6'>
              ...
              support helps us continue our work in fighting poverty, gender
              inequality, and building a sustainable future for all.
            </p>
