  ...
  const newsItems = [
    {
      ...
      description:
        "We've started a new program to provide eye care to children in rural areas...",
      date: 'July 15, 2025',
      category: 'Health',
      icon: '👁️',
    },
    {
      ...
      description:
        'Our Jal Jeevan project has successfully provided clean water to 5 villages...',
      date: 'July 10, 2025',
      category: 'Water',
      icon: '💧',
    },
    {
      ...
      description:
        "We're launching a new program to recognize and reward our dedicated volunteers...",
      date: 'July 5, 2025',
      category: 'Volunteer',
      icon: '🏆',
    },
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-16'>
          ...
          <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
            Stay updated with our latest initiatives, achievements, and
        ...
        <div className='mt-16 text-center'>
          <div className='bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 max-w-4xl mx-auto'>
            ...
            <p className='text-gray-600 mb-6'>
              Get real-time updates on our social media platforms and stay
