      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-16'>
          ...
          <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
            We work with dedicated organizations and individuals who share our
            vision for a better, more equitable future
          </p>
        </div>
        ...
        <div className='mt-16 text-center'>
          <div className='bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 max-w-4xl mx-auto'>
            ...
            <p className='text-gray-600 mb-6'>
              Are you an organization or individual who wants to make a
              difference? Let&apos;s collaborate to create lasting positive
